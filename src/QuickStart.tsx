...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Overlay shows toasts and countdown timers on top of the game. Place it where you like, then use Ctrl/Cmd+Shift+L for click-through so you can play through it, and Ctrl/Cmd+Shift+U to edit it again.",
  },
];
